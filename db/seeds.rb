...
user2 = User.find_or_initialize_by(email: 'mariana@gmail.com')
user2.password = 'password'
user2.password_confirmation = 'password'

garden4 = user.gardens.find_or_initialize_by(title: 'Jardin Botanico de Montreal', address: '4101 Sherbrooke St E, Montreal, Quebec H1X 2B2, Canadá')
